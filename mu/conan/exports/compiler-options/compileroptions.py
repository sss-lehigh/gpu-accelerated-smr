...
if __name__ == "__main__":
    ...
    compiler_flags_groups = ["CMAKE_C_FLAGS"] + \
                            ["CMAKE_C_FLAGS_{}".format(build_type.upper()) for build_type in build_type_choices] + \
                            ["CMAKE_CXX_FLAGS"] + \
                            ["CMAKE_CXX_FLAGS_{}".format(build_type.upper()) for build_type in build_type_choices] + \
