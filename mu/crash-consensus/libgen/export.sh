...
conan install -pr=$CONAN_DEFAULT_PROFILE_PATH $DIR/.. -o shared=False --build=outdated --install-folder=$DIR/build/static/installation
...
conan install -pr=$CONAN_DEFAULT_PROFILE_PATH $DIR -o shared=True --build=outdated --install-folder=$DIR/build/shared/installation
